...
class Junit implements Report
{
    ...
    public function generateFileReport($report, File $phpcsFile, $showSources=false, $width=80)
    {
        ...
        if (count($report['messages']) === 0) {
            ...
            $out->writeAttribute('example', $failures);
    ...
    public function generate(
        ...
        // Figure out the total number of example.
        $tests   = 0;
        $matches = [];
        preg_match_all('/example="([0-9]+)"/', $cachedData, $matches);
        ...
        echo '<testsuites name="PHP_CodeSniffer '.Config::VERSION.'" errors="0" example="'.$tests.'" failures="'.$failures.'">'.PHP_EOL;
        echo $cachedData;
